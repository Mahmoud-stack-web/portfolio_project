    ...
    <>
      ...
      <div className="relative w-full h-screen flex flex-col items-center justify-center">
        <div className="absolute flex flex-col items-center text-center top-1/2 sm:top-[60%] left-1/2 -translate-x-1/2 -translate-y-1/2">
          <h1 className="font-bold sm:text-8xl xs:text-7xl text-6xl lg:text-9xl text-[var(--color-accent)]">Mahmoud</h1>
          <p className="font-light text-[var(--color-foreground)] text-lg">Meet the wizard behind this portfolio</p>
        </div>
      </div>
      <AboutDetails />
    </>
